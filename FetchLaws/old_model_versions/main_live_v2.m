...
%
% ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
% Aprox time to run: ~3 hours (for 3 wind speeds, T = 10000, Tsteps = 2)
% ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
% Cite:
% ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
% 
...
UUvec = 0.4:1:3.3;                                                         % wind speeds to model [m/s]
...
rhow = 465;                                                                % liquid density [kg/m3] (550 kg/m^3 for 75% methane)
rhorat=rhoa/rhow;                                                          % air-water density ratio.

g = 1.35;                                                                  % gravity [m/s2]

% Viscocities:
nu = 0.0031/1e4;                                                           % liquid viscocity [m2/s]

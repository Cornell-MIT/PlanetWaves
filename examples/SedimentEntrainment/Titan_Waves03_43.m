...
time_to_run = 60*1;                                                   % time to run model
...
[zDep,buoy_loc,grid_resolution] = degrade_depth_resolution(zDep,buoy_loc,grid_resolution,0.08);
...
for c = 1:numel(lakes)
    ...
    for i = 1:numel(test_speeds)
            ...
            %save('Waves_OL_03_43.mat','test_speeds','time_to_run','lakecolors','wind_direction','zDep','buoy_loc','lakes','Planet','H0','L0','T','C0','Cg0'))
